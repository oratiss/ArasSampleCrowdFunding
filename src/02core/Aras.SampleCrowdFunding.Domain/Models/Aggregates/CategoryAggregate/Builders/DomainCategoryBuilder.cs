using Aras.SampleCrowdFunding.Domain.Models.Aggregates.CategoryAggregate;
using Aras.SampleCrowdFunding.Domain.Models.Aggregates.CategoryAggregate.Providers;
using Atisaz.Core.CreationalTools;

namespace Aras.SampleCrowdFunding.Domain.Models.Aggregates.CategoryAggregate.Builders
{
